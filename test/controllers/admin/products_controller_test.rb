...
class Admin::ProductsControllerTest < ActionController::TestCase
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post :create, admin_product: { codigo: @admin_product.codigo, description: @admin_product.description, marca_id: @admin_product.marca_id, precio: @admin_product.precio }
    end
  ...
  test "should update admin_product" do
    patch :update, id: @admin_product, admin_product: { codigo: @admin_product.codigo, description: @admin_product.description, marca_id: @admin_product.marca_id, precio: @admin_product.precio }
    assert_redirected_to admin_product_path(assigns(:admin_product))
  end
